...
namespace FluentApi.Web.Controllers
{
    ...
    public class CustomersApiController : ControllerBase
    {
        ...
        {//Eski yapıyı bu şekilde DTO nesnesine çeviririz.
        ...
        public async Task<ActionResult<Customer>> PostCustomer(Customer customer)
        {
            ...
            if (result.IsValid)
            {
                return BadRequest(result.Errors.Select(x => new { property = x.PropertyName, error = x.ErrorMessage }));//istersek hata sınıfı yapıp o sınıf üzerinden de değer verebilirdik
            }
